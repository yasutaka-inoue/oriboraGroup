...
const useStyles = makeStyles((theme) => ({
  ...
  const RequestItem = ({myId, history, id, picture,nickname, es_date, start_time, end_time, departure, destination, number, lan_1, lan_2, lan_3, status, rikkouho_id, emergency}) => {
    ...
    // rikkouho_idの数を取得
    const rikkouho =rikkouho_id.length;
